 ...
 *                                                                         *
 *  @desc Pokedex This file initializes pokemons and moves              *
...
void importPokemons()
{
    // @Array ATK,DEF,SPE,TYPE
    int pika[5] = {30, 40, 60, 5};
    Pokemon *pikachu = newPokemon("Pikachu", pika, 5, moves[0]);

    int luca[5] = {110, 70, 90, 11};
    Pokemon *lucario = newPokemon("Lucario", luca, 6, moves[0]);

    debug("Successfully imported pokemon");
}
...
void importMoves()
{
    ...
    debug("Successfully imported moves");
}
